...
#   DOWNSAMPLE_FRAC=1 bash tests/test_data/scripts/download_1000g_10sample_chr20_highcov_fixture.sh
#   FORCE=1 bash tests/test_data/scripts/download_1000g_10sample_chr20_highcov_fixture.sh
#
# Notes:
...
configure_cram_reference_cache() {
    ...
    # already present locally. Keep this cache outside OUTDIR: some reference
    # slices are larger than GitHub's regular-file limit.
